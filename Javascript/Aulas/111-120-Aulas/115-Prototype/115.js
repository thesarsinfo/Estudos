//todos objetos de javascripts tem herança direta do Objeto Prototype
//e com isso podemos reescrever ou criar metodos e propriedades da classes criadas no seu software
//como fosse um metodo overide em C# ou sobreescrever os metodos Nativos do javascript
...
//Criando metodos
Carro.prototype.infoTotal = function() //Nao aceita arrow function
{
    this.info();
    console.log("Pontecia Carro...: " + this.potencia)    
    console.log("Velocidade Atual.: " + this.velocidade)    
    console.log("Velocidade Max...: " + this.velMax)    
}
//sobrescrevendo metodos
/*
Carro.prototype.info = function() //Nao aceita arrow function
{    
    console.log("Pontecia Carro...: " + this.potencia)    
    console.log("Velocidade Atual.: " + this.velocidade)    
    console.log("Velocidade Max...: " + this.velMax)    
