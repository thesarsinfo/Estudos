...
export default function App(){  
  ...
  return(
    <> 
      {/*Estrutura Basica */}
      <Aula03/>
      {/*Espressoes e inserção de imagens */}
      <Aula04/>
      {/*Criando Componentes */}
      <Aula05/>
      {/*Enviar propriedades usando o props */}
      <Aula06/>
      ...
      <Aula09/>
      {/*O que é state e sua estrutura basica*/}
      <Aula10/>
      {/*Eventos em React */}
      <Aula11/>
      {/*Renderização condicional */}
      <Aula12/>
      {/*Trabalhando com lista em React e função MAP */}
      <Aula13/>
      ...
      {/*Elevação de State */}
      <Aula16/>
      {/* Desafio de unico state e varios itens de formulario */}
      <Desafio/>
      {/*Conteção em React*/}
      <Aula18/>
      {/*Hook useEffect em React */}
      <Aula19/>
      {/*Local Storage e suas funções*/}
      <Aula20/>
      ...
      {/*Bind e como usar */}
      <Aula24/>
      {/*Ciclo de vida nos componentes */}
      <Aula25/>
      {/*Estrutura de um componentes de Classe em React (Revisão Geral) */}
      <Aula26/>
      {/*Variaveis Globais */}
      <Aula27/>
      {/*Navegando entre telas de modo nativo*/}
      <Aula28/>
      {/*Exercicio usando tabela do html*/}
      <Aula29/>
      {/*Calculadora IMC*/}
      <Aula30/>
